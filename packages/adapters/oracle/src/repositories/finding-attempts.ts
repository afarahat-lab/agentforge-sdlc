/**
 * Finding-attempt repository — Oracle stub.
 *
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-oracle FindingAttemptRepository: not implemented');
};

export class OracleFindingAttemptRepository implements FindingAttemptRepository {
