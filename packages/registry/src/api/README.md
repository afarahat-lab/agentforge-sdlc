...
Typed HTTP client for the Gestalt registry service. Used by the CLI and harness initializer to search, pull, and submit registry entries.
...
- Default registry URL is https://registry.gestalt.dev — overridable for air-gapped environments
